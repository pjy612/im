...
{
    /// <summary>主播礼物表</summary>
    [ModelCheckMode(ModelCheckModes.CheckTableWhenFirstUse)]
    public class FanGifts : FanGifts<FanGifts> {
       
    }
    
    /// <summary>主播礼物表</summary>
    public partial class FanGifts<TEntity> : Entity<TEntity> where TEntity : FanGifts<TEntity>, new()
    {
        #region 对象操作
            ﻿
        static FanGifts()
