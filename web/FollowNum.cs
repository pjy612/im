...
namespace BiliEntity
{
    ...
    public partial class FollowNum<TEntity> : IFollowNum
    {
        ...
        #region 字段名
        /// <summary>取得主播关注数字段信息的快捷方式</summary>
        ...
        /// <summary>取得主播关注数字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>主播id</summary>
    ...
    /// <summary>主播关注数接口</summary>
    public partial interface IFollowNum
    {
        #region 属性
        /// <summary>主播id</summary>
        Int64 Uid { get; set; }
