...
public static class ImHelper
{
    ...
    public static void SendMessageOnline(object message, bool receipt = false) =>
        Instance.SendMessageOnline(message, receipt);
    ...
    /// </summary>
    /// <returns></returns>
    public static Dictionary<string, string> GetAllClientDataByOnline() => Instance.GetAllClientDataByOnline();
